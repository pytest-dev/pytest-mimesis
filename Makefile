...
VERSION = 0.3.15
PROJECT_NAME = pytest-elizabeth
REPOSITORY_URL = https://github.com/lk-geimfari/pytest-elizabeth
...
test:
	py.test --cov=pytest_elizabeth/ --cov-report=term-missing  --verbose --color=yes $(ROOT)

test-travis:
	py.test --cov=pytest_elizabeth/
